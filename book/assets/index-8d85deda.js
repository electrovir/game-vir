...
`,em=ve({name:"LoaderAnimated24Icon",svgTemplate:p`
    ...
    `,initCallback({host:e,state:t}){setTimeout(()=>{uu(e,Gs(t.currentRoute.paths),t.currentRoute)},500)},cleanupCallback({state:e,updateState:t}){e.router&&(e.router.destroy(),t({router:void 0}))},renderCallback:({state:e,inputs:t,host:r,updateState:n,dispatch:i,events:s})=>{var d,u,f,h,m,g,y;t._debug&&console.info("rendering element-book app");function a(b){return{...e.currentRoute,...b}}function o(b){const E=a(b);return!ce(e.currentRoute,E)}function l(b){t.preventWindowTitleChange||(e.originalWindowTitle||n({originalWindowTitle:document.title}),document.title=[e.originalWindowTitle,b].filter(ga).join(" - "))}function c(b){if(!o(b))return;const E=a(b);e.router?e.router.setRoute(E):n({currentRoute:{...e.currentRoute,...E}}),t.elementBookRoutePaths&&!ce(t.elementBookRoutePaths,e.currentRoute.paths)&&i(new s.pathUpdate(E.paths??[]))}try{if(t.elementBookRoutePaths&&!ce(t.elementBookRoutePaths,e.currentRoute.paths)&&c({paths:t.elementBookRoutePaths}),(d=t.internalRouterConfig)!=null&&d.useInternalRouter&&!e.router){const H=tb(t.internalRouterConfig.basePath);n({router:H}),H.listen(!0,W=>{n({currentRoute:W})})}else!((u=t.internalRouterConfig)!=null&&u.useInternalRouter)&&e.router&&e.router.destroy();const b={themeColor:t.themeColor};if(!ce(b,(f=e.colors)==null?void 0:f.config)){const H=_c(b);n({colors:{config:b,theme:H}}),ib(r,H)}const E=t._debug??!1,C=Sy({entries:t.entries,debug:E});(!e.treeBasedControls||e.treeBasedControls.entries!==t.entries||e.treeBasedControls.lastGlobalInputs!==t.globalValues)&&(t._debug&&console.info("regenerating global controls"),n({treeBasedControls:{entries:t.entries,lastGlobalInputs:t.globalValues??{},controls:Jf(C.tree,{children:(m=(h=e.treeBasedControls)==null?void 0:h.controls)==null?void 0:m.children,controls:t.globalValues})}}));const O=Gs(e.currentRoute.paths),Pe=(O?Ly({flattenedNodes:C.flattenedNodes,searchQuery:O}):void 0)??c2(C.flattenedNodes,e.currentRoute.paths,c);l((g=Pe[0])==null?void 0:g.entry.title);const me=(y=e.treeBasedControls)==null?void 0:y.controls;return me?(t._debug&&console.info({currentControls:me}),p`
            ...
            `}}});async function uu(e,t,r){if(t||r.paths.length<=1)return;const n=e.shadowRoot.querySelector(Ue.tagName);if(!(n instanceof Ue))throw new Error(`Failed to find child '${Ue.tagName}'`);await a2(n)}function yi(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function u2(e){return yi(e).map(t=>e[t])}function vr(e){return yi(e).map(t=>[t,e[t]])}function d2(e){return Object.fromEntries(e)}function f2(e,t){return e.filter((r,n)=>!t.includes(n))}function h2(e,t,r){return e.reduce((n,i,s,a)=>{const o=t(i,s,a);return r(o,i,s,a)&&n.push(o),n},[])}function m2(e){return!!e}var du;(function(e){e.Upper="upper",e.Lower="lower"})(du||(du={}));function p2({max:e,min:t,value:r}){return r>e?t:r<t?e:r}var fu;(function(e){e.FirstThenWait="first-then-wait",e.AfterWait="after-wait"})(fu||(fu={}));function dr(e,t){let r=!1;const n=yi(e).reduce((i,s)=>{const a=t(s,e[s],e);return a instanceof Promise&&(r=!0),{...i,[s]:a}},{});return r?new Promise(async(i,s)=>{try{await Promise.all(yi(n).map(async a=>{const o=await n[a];n[a]=o})),i(n)}catch(a){s(a)}}):n}function g2(){return globalThis.crypto?globalThis.crypto:require("crypto").webcrypto}g2();const hu=fe()({tagName:"vir-players-actions-bindings-debug",styles:$`
        h3 {
            margin: 4px;
        }
    `,renderCallback({inputs:e}){return vr(e.playersActionsBindingsMap).map(([t,r])=>p`
                    <h3>Player ${t}</h3>
                    <${mu.assign({actionsBindingsMap:r})}></${mu}>
                `)}}),mu=fe()({tagName:"vir-actions-bindings-debug",styles:$`
        h4 {
            margin: 4px;
        }
    `,renderCallback({inputs:e}){return vr(e.actionsBindingsMap).map(([t,r])=>{const n=r.map(i=>p`
                ...
                `})}}),w2=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function bi(e,t){return e?w2.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function fr(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}function aa(e){return fr(e).map(t=>e[t])}function y2(e){return Object.fromEntries(e)}function b2(e,t){return e.includes(t)}function vi(e){return!!e}const v2={capitalizeFirstLetter:!1};function $2(e){return e.length?e[0].toUpperCase()+e.slice(1):""}function E2(e,t){return t.capitalizeFirstLetter?$2(e):e}function T2(e,t=v2){const r=e.toLowerCase();if(!r.length)return"";const n=r.replace(/^-+/,"").replace(/-{2,}/g,"-").replace(/-(?:.|$)/g,i=>{const s=i[1];return s?s.toUpperCase():""});return E2(n,t)}var pu;(function(e){e.Upper="upper",e.Lower="lower"})(pu||(pu={}));function S2(e,t){return e.split(t)}var gu;(function(e){e.FirstThenWait="first-then-wait",e.AfterWait="after-wait"})(gu||(gu={}));function k2(e){return fr(e).filter(t=>isNaN(Number(t)))}function x2(e){return k2(e).map(r=>e[r])}function M2(e,t){return x2(t).includes(e)}function A2(e,t){let r=!1;const n=fr(e).reduce((i,s)=>{const a=t(s,e[s],e);return a instanceof Promise&&(r=!0),{...i,[s]:a}},{});return r?new Promise(async(i,s)=>{try{await Promise.all(fr(n).map(async a=>{const o=await n[a];n[a]=o})),i(n)}catch(a){s(a)}}):n}function C2(){return globalThis.crypto?globalThis.crypto:require("crypto").webcrypto}C2();const om={Gamepad1:"0",Gamepad2:"1",Gamepad3:"2",Gamepad4:"3"};function lm(e){return b2(Object.values(om),e)}const P2={Mouse:"mouse",Keyboard:"keyboard"},G={...P2,...om};var j;(function(e){e.Keyboard="keyboard",e.Mouse="mouse",e.Gamepad="gamepad"})(j||(j={}));var hr;(function(e){e.Button="button",e.Axe="axe"})(hr||(hr={}));function Ir(e){return`button-${e}`}function oa(e){return`axe-${e}`}function L2(e){const[t]=S2(e,"-");if(M2(t,hr))return t;throw new Error(`Failed to parse input type from input named '${e}'`)}const O2=.01;function N2({value:e,gamepadDeadZone:t,globalDeadZone:r}){const n=t??(r||O2);return Math.abs(e)>n?e:0}function wu({gamepadInput:e,inputIndex:t,deadZones:r,globalDeadZone:n}){const i=T(e,"number"),s=i?oa(t):Ir(t),a=i?e:e.value;return{inputName:s,value:N2({value:a,gamepadDeadZone:r[s],globalDeadZone:n}),inputType:i?hr.Axe:hr.Button}}function I2({gamepad:e,deadZoneSettings:t,globalDeadZone:r}){const n=String(e.index);if(!lm(n))throw new Error(`Tried to serialize gamepad with out-of-bounds index: '${e.index}'`);const i=t[e.id]||{},s=e.axes.map((l,c)=>wu({gamepadInput:l,inputIndex:c,deadZones:i,globalDeadZone:r})),a=e.buttons.map((l,c)=>wu({deadZones:i,gamepadInput:l,globalDeadZone:r,inputIndex:c})),o=y2([...a,...s].map(l=>[l.inputName,l]));return{axes:s,buttons:a,isConnected:e.connected,gamepadName:e.id,deviceKey:n,mapping:e.mapping,serialized:!0,timestamp:e.timestamp,inputsByName:o}}const Hn=window.navigator;function D2({deadZoneSettings:e,globalDeadZone:t}){return Array.from(bi(Hn,"webkitGetGamepads")?Hn.webkitGetGamepads():bi(Hn,"getGamepads")?Hn.getGamepads():[]).filter(r=>!!r).map(r=>I2({gamepad:r,deadZoneSettings:e,globalDeadZone:t}))}function R2({deadZoneSettings:e,globalDeadZone:t}){return D2({deadZoneSettings:e,globalDeadZone:t}).reduce((i,s)=>{const a=s.deviceKey;return lm(a)?(i[a]=s,i):(console.warn(`ignoring gamepad index '${a}'`),i)},{})}function _2(e){const t={},r={deviceKey:e.deviceKey,deviceName:e.gamepadName,deviceType:j.Gamepad};return Object.values(e.inputsByName).forEach(n=>{n.value&&(t[n.inputName]={...r,details:n,inputName:n.inputName,inputValue:n.value})}),t}function V2(e){return A2(e,(t,r)=>({currentInputs:_2(r),deviceDetails:r,deviceName:r.gamepadName,deviceKey:r.deviceKey,deviceType:j.Gamepad}))}function yu(e){return aa(e).map(n=>n==null?void 0:n.currentInputs).filter(vi).map(n=>aa(n)).flat()}const bu={deviceDetails:void 0,deviceKey:G.Keyboard,deviceName:"keyboard",deviceType:j.Keyboard},Bn={deviceDetails:void 0,deviceKey:G.Mouse,deviceName:"mouse",deviceType:j.Mouse},cm={[G.Gamepad1]:j.Gamepad,[G.Gamepad2]:j.Gamepad,[G.Gamepad3]:j.Gamepad,[G.Gamepad4]:j.Gamepad,[G.Keyboard]:j.Keyboard,[G.Mouse]:j.Mouse};var H2=globalThis&&globalThis.__setFunctionName||function(e,t,r){return typeof t=="symbol"&&(t=t.description?"[".concat(t.description,"]"):""),Object.defineProperty(e,"name",{configurable:!0,value:r?"".concat(r," ",t):t})};function zi(){return(e,t)=>{var r;const n=T2(e,{capitalizeFirstLetter:!0}),i=(r=class extends be()(e){constructor(){super(...arguments),Object.defineProperty(this,"eventType",{enumerable:!0,configurable:!0,writable:!0,value:e})}static constructIfDataIsNew(s,...a){const o=i.getNewData(...a);if(o)return new i({detail:{timestamp:s,inputs:o}})}},H2(r,"TimedEventConstructor"),Object.defineProperty(r,"getNewData",{enumerable:!0,configurable:!0,writable:!0,value:t}),r);return Object.defineProperty(i,"name",{value:n,writable:!0}),i}}function B2(...[e,t]){return t}const F2=zi()("all-devices-updated",B2);function vu(e,t){return e.deviceKey===t.deviceKey&&e.inputName===t.inputName&&e.inputName===t.inputName&&e.inputValue===t.inputValue}function U2(...[e,t]){const r=yu(t),n=e?yu(e):[];if(!ce(n,r)){const i=r.filter(a=>!n.find(o=>vu(o,a))),s=n.filter(a=>!r.find(o=>vu(o,a)));return{newInputs:i,removedInputs:s,allCurrentInputs:r}}}const oo=zi()("current-inputs-changed",U2);function j2(...[e,t]){if(!e)return[];const r=fr(e).filter(n=>!bi(t,n));if(r.length)return r.map(n=>e[n]).filter(vi)}const um=zi()("devices-removed",j2);function z2(...[e,t]){if(!e)return aa(t).filter(vi);const r=fr(t).filter(n=>!bi(e,n));if(r.length)return r.map(n=>t[n]).filter(vi)}const dm=zi()("new-devices-added",z2),fm=[F2,dm,um,oo];Object.fromEntries(fm.map(e=>[e.type,e]));const $u="code";class wn extends sd{constructor(t={}){super(),Object.defineProperty(this,"currentKeyboardInputs",{enumerable:!0,configurable:!0,writable:!0,value:{}}),Object.defineProperty(this,"currentMouseInputs",{enumerable:!0,configurable:!0,writable:!0,value:{}}),Object.defineProperty(this,"gamepadDeadZoneSettings",{enumerable:!0,configurable:!0,writable:!0,value:{}}),Object.defineProperty(this,"lastReadInputDevices",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"loopIsRunning",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"globalDeadZone",{enumerable:!0,configurable:!0,writable:!0,value:0}),Object.defineProperty(this,"removeGlobalListeners",{enumerable:!0,configurable:!0,writable:!0,value:()=>{}}),Object.defineProperty(this,"currentLoopIndex",{enumerable:!0,configurable:!0,writable:!0,value:-1}),Object.defineProperty(this,"lastEventDetails",{enumerable:!0,configurable:!0,writable:!0,value:{}}),t.gamepadDeadZoneSettings&&this.updateGamepadDeadZoneSettings(t.gamepadDeadZoneSettings),t.globalDeadZone&&(this.globalDeadZone=t.globalDeadZone),this.attachWindowListeners(t),this.readAllDevices(),t.startLoopImmediately&&this.startPollingLoop()}attachWindowListeners(t){const r=[$t("keydown",n=>{const i=Ir(n[$u]);if(this.currentKeyboardInputs.hasOwnProperty(i))return;const s={deviceType:j.Keyboard,details:{keyboardEvent:n},deviceKey:G.Keyboard,deviceName:bu.deviceName,inputName:i,inputValue:1};this.currentKeyboardInputs[i]=s}),$t("keyup",n=>{delete this.currentKeyboardInputs[Ir(n[$u])]}),$t("mousedown",n=>{const i=Ir(n.button);this.currentMouseInputs.hasOwnProperty(i)||(this.currentMouseInputs[i]={deviceType:j.Mouse,details:{mouseEvent:n},deviceName:Bn.deviceName,deviceKey:G.Mouse,inputName:i,inputValue:1})}),$t("mouseup",n=>{delete this.currentMouseInputs[Ir(n.button)]}),t.disableMouseMovement?void 0:$t("mousemove",n=>{const i=oa("x"),s=oa("y");this.currentMouseInputs[i]={deviceType:j.Mouse,details:{mouseEvent:n},deviceName:Bn.deviceName,deviceKey:G.Mouse,inputName:i,inputValue:n.clientX},this.currentMouseInputs[s]={deviceType:j.Mouse,details:{mouseEvent:n},deviceName:Bn.deviceName,deviceKey:G.Mouse,inputName:s,inputValue:n.clientY}})];this.removeGlobalListeners=()=>{r.forEach(n=>n==null?void 0:n())}}runPollingLoop(t,r){this.loopIsRunning&&this.currentLoopIndex===t&&(this.readAllDevices(this.gamepadDeadZoneSettings,r),requestAnimationFrame(n=>{this.runPollingLoop(t,n)}))}fireEvents(t,r,n){fm.forEach(i=>{const s=i.constructIfDataIsNew(t,r,n);s&&(this.lastEventDetails[s.type]={constructor:i,constructorInputs:[t,r,n]},this.dispatch(s))})}getCurrentDeviceValues(t,r){const n=R2({deadZoneSettings:t,globalDeadZone:r}),i=V2(n);return{[G.Keyboard]:{...bu,currentInputs:{...this.currentKeyboardInputs}},[G.Mouse]:{...Bn,currentInputs:{...this.currentMouseInputs}},...i}}startPollingLoop(){this.loopIsRunning||(this.loopIsRunning=!0,this.currentLoopIndex++,requestAnimationFrame(t=>{this.runPollingLoop(this.currentLoopIndex,t)}))}pausePollingLoop(){this.loopIsRunning&&(this.loopIsRunning=!1)}getLastPollResults(){return this.lastReadInputDevices}readAllDevices(t=this.gamepadDeadZoneSettings,r=performance.now(),n=this.globalDeadZone){const i=this.getCurrentDeviceValues(t,n),s=this.lastReadInputDevices;return this.lastReadInputDevices=i,this.fireEvents(r,s,i),i}updateGamepadDeadZoneSettings(t){this.gamepadDeadZoneSettings=t}}class Eu extends be()("vir-line-pause"){}class hm extends be()("vir-line-state-rate-calculated"){}class W2 extends be()("vir-line-state-change"){}class Tu extends be()("vir-line-error"){}class G2 extends rn("vir-line-update-skipped"){}class K2 extends rn("vir-line-destroy"){}const mm="animation frames",q2={allowDuplicateStageNames:!1,enableLogging:!1,targetUpdateRate:void 0,init:{startUpdateLoopImmediately:!1},minUpdateRateCalculationInterval:{milliseconds:500},updateLoopInterval:mm},Z2=[(e,t)=>t in e,(e,t)=>t in e.constructor.prototype];function Y2(e,t){return e?Z2.some(r=>{try{return r(e,t)}catch{return!1}}):!1}function la(e){let t;try{t=Reflect.ownKeys(e)}catch{}return t??[...Object.keys(e),...Object.getOwnPropertySymbols(e)]}async function J2(e,t){await X2(e,t)}async function X2(e,t){return await e.reduce(async(n,i,s,a)=>{const o=await n,l=await t(i,s,a);return o.push(l),o},Promise.resolve([]))}function Q2(e){return!!e}function e5({value:e,wrapper:t}){return[t,t].join(e)}var Su;(function(e){e.Upper="upper",e.Lower="lower"})(Su||(Su={}));var ku;(function(e){e.FirstThenWait="first-then-wait",e.AfterWait="after-wait"})(ku||(ku={}));function t5(e){return e?e instanceof Error?e.message:Y2(e,"message")?String(e.message):String(e):""}function r5(e){return e instanceof Error?e:new Error(t5(e))}function xu(e,t){const r=r5(e);return r.message=`${t}: ${r.message}`,r}function n5(e,t){return la(e).filter(n=>{const i=e[n];return t(n,i,e)}).reduce((n,i)=>(n[i]=e[i],n),{})}function i5(e,t){return n5(e,r=>!t.includes(r))}function s5(e,t){let r=!1;const n=la(e).reduce((i,s)=>{const a=t(s,e[s],e);return a instanceof Promise&&(r=!0),{...i,[s]:a}},{});return r?new Promise(async(i,s)=>{try{await Promise.all(la(n).map(async a=>{const o=await n[a];n[a]=o})),i(n)}catch(a){s(a)}}):n}function ca(e,t){try{return a5(e,t),!0}catch{return!1}}function a5(e,t,r){if(e.length<t)throw new Error(r?`'${r}' is not at least '${t}' in length.`:`Array is not at least '${t}' in length.`)}function pm(...e){if(!ca(e,1))return{};if(e.length===1)return e[0];let t;const r={};return e.forEach(n=>{if(T(n,"object"))T(t,"object")||(t={...n});else{t=n;return}Object.entries(n).forEach(([i,s])=>{r[i]||(r[i]=[]),r[i].push(s)})}),T(t,"object")&&Object.entries(r).forEach(([n,i])=>{const s=pm(...i);s===void 0&&n in t?delete t[n]:s!==void 0&&(t[n]=s)}),t}function o5(e){return!!e&&typeof e=="object"}function l5(e){return Km(e)||e instanceof RegExp||e instanceof Promise}function ua(e,t){if(Array.isArray(e))return e.map(n=>ua(n,t));const r=[];return i5(s5(e,(n,i)=>{const s=t[n];if(s===!0)return i;if(s)return ua(i,s);r.push(n)}),r)}function Mu(e,t){const r=ua(e,t);return da(r,t)}function da(e,t){if(l5(e))return e;const r=Object.keys(e);return Array.isArray(e)?e.map(n=>da(n,t)):ca(r,2)?e:ca(r,1)&&o5(t)?da(e[r[0]],t[r[0]]):e}async function Au(e){return await Promise.resolve().then(()=>e())}function c5(){return globalThis.crypto?globalThis.crypto:require("crypto").webcrypto}c5();function u5(e,t){const r=[],n=new Set;if(e.forEach(i=>{const s=i.stageId.name;n.has(s)?r.push(s):n.add(s)}),r.length&&!t.allowDuplicateStageNames)throw new Error(`Duplicate stage names provided to VirLine: ${r.join(", ")}`)}function d5(e){return[e.name,e.version!=null?String(e.version):void 0].filter(Q2).join("@")}function Jn(e,t){if(e===t)return!0;if(e&&t&&typeof e=="object"&&typeof t=="object"){if(e.constructor!==t.constructor)return!1;var r,n,i;if(Array.isArray(e)){if(r=e.length,r!=t.length)return!1;for(n=r;n--!==0;)if(!Jn(e[n],t[n]))return!1;return!0}if(e instanceof Map&&t instanceof Map){if(e.size!==t.size)return!1;for(n of e.entries())if(!t.has(n[0]))return!1;for(n of e.entries())if(!Jn(n[1],t.get(n[0])))return!1;return!0}if(e instanceof Set&&t instanceof Set){if(e.size!==t.size)return!1;for(n of e.entries())if(!t.has(n[0]))return!1;return!0}if(ArrayBuffer.isView(e)&&ArrayBuffer.isView(t)){if(r=e.length,r!=t.length)return!1;for(n=r;n--!==0;)if(e[n]!==t[n])return!1;return!0}if(e.constructor===RegExp)return e.source===t.source&&e.flags===t.flags;if(e.valueOf!==Object.prototype.valueOf)return e.valueOf()===t.valueOf();if(e.toString!==Object.prototype.toString)return e.toString()===t.toString();if(i=Object.keys(e),r=i.length,r!==Object.keys(t).length)return!1;for(n=r;n--!==0;)if(!Object.prototype.hasOwnProperty.call(t,i[n]))return!1;for(n=r;n--!==0;){var s=i[n];if(!Jn(e[s],t[s]))return!1}return!0}return e!==e&&t!==t}class Wi extends va{get stateType(){throw new Error("Access to 'stateType' is only allowed as a type.")}constructor(t,r,n){super(),Object.defineProperty(this,"stages",{enumerable:!0,configurable:!0,writable:!0,value:t}),Object.defineProperty(this,"options",{enumerable:!0,configurable:!0,writable:!0,value:q2}),Object.defineProperty(this,"isUpdateLoopPaused",{enumerable:!0,configurable:!0,writable:!0,value:!0}),Object.defineProperty(this,"currentState",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"lastStateUpdateHighResTimestamp",{enumerable:!0,configurable:!0,writable:!0,value:0}),Object.defineProperty(this,"updateRateCounters",{enumerable:!0,configurable:!0,writable:!0,value:{calculatedAtHighResTimestamp:performance.now(),updateCount:0}}),Object.defineProperty(this,"isCurrentlyUpdating",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"stateListeners",{enumerable:!0,configurable:!0,writable:!0,value:[]}),this.currentState={...r},n&&this.updateOptions(n),u5(t,this.options),this.options.init.startUpdateLoopImmediately&&this.startUpdateLoop()}updateOptions(t){this.options=pm(this.options,t)}startUpdateLoop(){return this.isUpdateLoopPaused?(this.isUpdateLoopPaused=!1,this.dispatch(new Eu({detail:!1})),this.updateRateCounters={calculatedAtHighResTimestamp:performance.now(),updateCount:0},this.runUpdateLoop(),!0):!1}pauseUpdateLoop(){return this.isUpdateLoopPaused?!1:(this.isUpdateLoopPaused=!0,this.dispatch(new Eu({detail:!0})),!0)}destroy(){this.pauseUpdateLoop(),this.removeAllStateListeners(),this.dispatch(new K2),super.destroy()}listenToState(t,r,n){const i=this.stateListeners.find(a=>ce(a.selection,r)),s=Mu(this.currentState,r);return i?i.listeners.add(n):this.stateListeners.push({selection:r,lastValue:s,listeners:new Set([n])}),t&&n(s),()=>this.removeStateListener(r,n)}removeAllStateListeners(){this.stateListeners=[]}removeStateListener(t,r){const n=this.stateListeners.findIndex(s=>ce(s.selection,t)),i=this.stateListeners[n];return!i||!i.listeners.delete(r)?!1:(i.listeners.size||this.stateListeners.splice(n,1),!0)}async triggerUpdate(){if(this.isCurrentlyUpdating){this.dispatch(new G2),this.options.enableLogging&&console.warn("Update skipped: another is still in progress.");return}this.isCurrentlyUpdating=!0;const t=performance.now(),r={milliseconds:t-this.lastStateUpdateHighResTimestamp};this.lastStateUpdateHighResTimestamp=t,this.updateRateCounters.updateCount++,this.options.enableLogging&&console.info(`updating state at: ${t}`);const n=await this.runStateUpdate(t,r);if(this.options.enableLogging&&console.info(`state update took: ${performance.now()-t}`),this.isCurrentlyUpdating=!1,n)throw n;this.fireStateListeners()}runUpdateLoop(){Au(()=>this.triggerUpdate());const t=()=>{this.isUpdateLoopPaused||this.runUpdateLoop()};if(this.options.updateLoopInterval===mm)window.requestAnimationFrame(t);else{const r=jr(this.options.updateLoopInterval,M.Milliseconds);setTimeout(t,r.milliseconds)}}async fireStateListeners(){this.dispatch(new W2({detail:this.currentState}));const t=[];this.stateListeners.forEach(r=>{const n=Mu(this.currentState,r.selection);Jn(n,r.lastValue)||(r.lastValue=n,r.listeners.forEach(i=>{t.push(Au(async()=>await i(n)))}))}),await Promise.all(t)}async runStateUpdate(t,r){try{const n={timeSinceLastUpdate:r,updateStartTime:{milliseconds:t}};await J2(this.stages,async i=>{const s={...n,state:this.currentState};try{await i.executor(s)}catch(a){const o=xu(a,`Stage ${e5({value:d5(i.stageId),wrapper:"'"})} failed`);console.error(o),this.dispatch(new Tu({detail:o}))}}),this.calculateUpdateRate(t);return}catch(n){const i=xu(n,"Failed to update state");return console.error(i),this.dispatch(new Tu({detail:i})),i}}calculateUpdateRate(t){if(this.options.minUpdateRateCalculationInterval==null)return;const r=jr(this.options.minUpdateRateCalculationInterval,M.Milliseconds).milliseconds,n=t-this.updateRateCounters.calculatedAtHighResTimestamp;if(n>r){const i=this.updateRateCounters.updateCount;this.updateRateCounters={calculatedAtHighResTimestamp:t,updateCount:0},this.dispatch(new hm({detail:{calculatedAt:ow(t+performance.timeOrigin,Zg),durationSinceLastCalculation:{milliseconds:n},updateCount:i,updatesPerSecond:i/n*1e3}}))}}}function f5(e){return d2(vr(e).map(([t,r])=>[r,t]))}function h5(){return lo}const lo={stageId:{name:"read actions"},executor({state:e,timeSinceLastUpdate:t}){if(!e.playersActionsBindings||!Object.keys(e.playersActionsBindings).length||!e.rawInputs||!Object.keys(e.rawInputs).length){e.playersActiveActions={};return}const r=f5(e.deviceKeyMap||{}),n=dr(e.playersActionsBindings,(i,s)=>{var a;return m5({actionsBindingsMap:s,activeActionsMap:(a=e.playersActiveActions)==null?void 0:a[i],rawInputs:e.rawInputs,reversedDeviceKeyMap:r,timeSinceLastUpdate:t})});e.playersActiveActions=n}};function m5({actionsBindingsMap:e,activeActionsMap:t,reversedDeviceKeyMap:r,rawInputs:n,timeSinceLastUpdate:i}){return vr(e).reduce((s,[a,o])=>{const l=h2(o,c=>{var f;const d=r[c.deviceKey]??c.deviceKey,u=(f=n==null?void 0:n[d])==null?void 0:f[c.inputName];if((u==null?void 0:u.direction)===c.direction)return u},m2);if(l.length){const c=l.reduce((m,g)=>m+g.inputValue,0),d=t==null?void 0:t[a],u=d==null?void 0:d.holdDuration,f=u?u.milliseconds+i.milliseconds:0,h={holdDuration:{milliseconds:Math.round(f)},value:c,actCount:(d==null?void 0:d.actCount)||0,lastActDuration:(d==null?void 0:d.lastActDuration)||{milliseconds:0}};s[a]=h}return s},{})}var q=(e=>(e.Positive="positive",e.Flat="flat",e.Negative="negative",e))(q||{});function gm(e){return e===0?"flat":e<0?"negative":"positive"}function p5(e){return dr(e,(t,r)=>({deviceKey:t,deviceName:r.deviceName,deviceType:r.deviceType}))}const Gi={stageId:{name:"read raw input"},executor({state:e,timeSinceLastUpdate:t}){const r=e.deviceHandler.readAllDevices(),n=dr(r,(s,a)=>{const o=a;return dr(o.currentInputs,(l,c)=>{var h,m;const d=gm(c.inputValue),u=(m=(h=e.rawInputs)==null?void 0:h[s])==null?void 0:m[l],f=(u==null?void 0:u.direction)===d?{milliseconds:u.duration.milliseconds+t.milliseconds}:{milliseconds:0};return{deviceKey:s,deviceName:o.deviceName,deviceType:o.deviceType,direction:d,duration:f,inputName:l,inputValue:c.inputValue}})}),i=p5(r);e.rawInputs=n,e.currentInputDevices=i}},g5={1:{jump:[{deviceKey:"keyboard",direction:q.Positive,inputName:"button-Space"}],left:[{deviceKey:"keyboard",direction:q.Positive,inputName:"button-KeyA"},{deviceKey:"keyboard",direction:q.Positive,inputName:"button-KeyJ"},{deviceKey:"keyboard",direction:q.Positive,inputName:"button-ArrowLeft"}],right:[{deviceKey:"keyboard",direction:q.Positive,inputName:"button-KeyD"},{deviceKey:"keyboard",direction:q.Positive,inputName:"button-KeyL"},{deviceKey:"keyboard",direction:q.Positive,inputName:"button-ArrowRight"}]}},Cu=fe()({tagName:"vir-read-actions-stage-debug",styles:$`
        :host {
            display: flex;
            gap: 16px;
            flex-direction: column;
    ...
    `,stateInitStatic:{deviceHandler:void 0,pipeline:void 0,activeActions:{}},initCallback({state:e,updateState:t,inputs:r}){const n=e.deviceHandler||r.inputDeviceHandler||new wn;e.deviceHandler||t({deviceHandler:n});const i=e.pipeline||new Wi([Gi,lo],{deviceHandler:n,playersActionsBindings:r.actionBindings||g5},{init:{startUpdateLoopImmediately:!0}});e.pipeline||t({pipeline:i}),i.listenToState(!0,{playersActiveActions:!0},s=>{t({activeActions:s||{}})})},cleanupCallback({inputs:e,state:t,updateState:r}){var n,i;e.inputDeviceHandler||(n=t.deviceHandler)==null||n.destroy(),(i=t.pipeline)==null||i.destroy(),r({deviceHandler:void 0,pipeline:void 0})},renderCallback({state:e}){if(!e.deviceHandler||!e.pipeline)return N;const t=Object.entries(e.activeActions).map(([i,s])=>p`
            ...
            <${hu.assign({playersActionsBindingsMap:n})}></${hu}>
            <h2>Active Actions</h2>
            ${r?p`
                      <p class="no-actions">No inputs</p>
                  `:t}
        `},options:{ignoreUnsetInputs:!0}}),Pu=fe()({tagName:"vir-read-raw-input-stage-debug",styles:$`
        :host {
            display: flex;
            gap: 16px;
            flex-wrap: wrap;
    ...
    `,events:{inputListen:ie(),bindingsUpdate:ie()},stateInitStatic:{listeningForAction:void 0},renderCallback({inputs:e,dispatch:t,events:r,state:n,updateState:i}){const s=e.actionNames.map(a=>{var f;const o=((f=e.playersActionsBindings)==null?void 0:f[`${e.playerPosition}`])||{},l=o[a]||[],c=l.length?l.map((h,m)=>p`
                          <${Os.assign({...h})}
                              ${R(Os.events.removeBinding,()=>{const g={...o,[a]:f2(l,[m])};t(new r.bindingsUpdate(g))})}
                          ></${Os}>
                      `):p`
